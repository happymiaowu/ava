...
class QLearnAgent(Agent):
    ...
    def __init__(self, team, agent_model_path=None):
        super().__init__(team)
        self.qfunc = dict()
        self.valid_action = ['attack', 'reinforce', 'rally', 'scout', 'speedup', 'teleport', 'recall_march', 'recall_occupied', 'join_rally', 'cancel_rally']
        if agent_model_path:
